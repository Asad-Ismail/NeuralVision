...
class InstanceSegmentationModel(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        steps_per_epoch = len(self.trainer.datamodule.train_dataloader())  # Access train_dataloader from the data module
...
def main(perform_inference=False):
    ...
    lightning_module = InstanceSegmentationModel(num_classes,backbone_name,learning_rate=1e-3)
